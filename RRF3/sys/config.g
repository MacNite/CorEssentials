...
M671 X-50:-50:290:290 Y20:210:210:20 S10		; position of z belts
M350 X16 Y16 Z16 E16 I0                                 ; configure microstepping with interpolation for X Y Z E
M92 X80 Y80 Z400 E415                                   ; set steps per mm
;M566 X900 Y900 Z120 E300                                ; set maximum instantaneous speed changes (mm/min)
M566 X300 Y300 Z60 E300                                ; set maximum instantaneous speed changes (mm/min)
M203 X24000 Y24000 Z3000 E6000                          ; set maximum speeds (mm/min)
M201 X3000 Y3000 Z300 E800                              ; set accelerations (mm/s^2)
...
M208 X240 Y255 Z280 S0                                 ; set axis maxima
...
; Z-Probe
M558 P5 C"zprobe.in" H10 F120 I1 T12000                ; set Z probe type to switch and the dive height + speeds
